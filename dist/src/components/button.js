...
var buttonStyle = function (theme) { return ({
    ...
    secondary: {
        default: {
            ...
            border: "1px solid ".concat(theme.colors.mainColor.main),
        },
        disabled: {
        ...
        hover: {
            ...
            border: "1px solid ".concat(theme.colors.mainColor.main7),
        },
    },
}); };
